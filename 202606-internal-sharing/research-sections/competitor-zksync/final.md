...
final_metadata:
  ...
  promoted_at: "2026-05-24T06:17:47+08:00"
  mode: "lightweight_final_promotion"
  approved_draft_path: "202606-internal-sharing/research-sections/competitor-zksync/drafts/round-2.md"
  approved_draft_round: 2
  approved_draft_commit: "61ed3ae493e6ca85bcf568254afd6d6497ee78ea"
  approval_evidence: "Multica comment a8c2a45d-04ed-4f52-8067-81493979134d (Review Verdict: approve, round 2, severity: minor)"
  branch: "research/202606-internal-sharing/competitor-zksync"
  reviewer_caveats_carried_forward:
    - "Source appendix commits summarized raw/normalized tables and source links rather than full raw JSON exports."
    - "Some supporting query families are represented by templates plus recorded outputs rather than every per-repo command expansion."
  promotion_notes:
    - "Promoted approved round-2 draft to final.md."
...
- **Source appendix caveat**: committed source appendix preserves summarized raw/normalized tables and durable source links rather than full raw JSON exports; some supporting query families are represented by query templates plus recorded outputs rather than every per-repo command expansion.
