...
final_metadata:
  ...
  promoted_at: "2026-05-24T05:43:28+08:00"
  mode: lightweight_final_promotion
  approved_draft_path: "202606-internal-sharing/research-sections/narrative-analysis/drafts/round-1.md"
  approved_draft_round: 1
  approved_draft_commit: "14564895039923018693657ac0550931ed930e10"
  approval_evidence: "Multica comment 2473b61b-d312-4679-887d-3abb74523ef3 (Review Verdict: approve, severity: minor)"
  branch: "research/202606-internal-sharing/narrative-analysis"
  finalization_caveats_preserved:
    - "Social/media (X/Twitter) coverage remains partial and caveated; this final section does not upgrade it to full coverage."
    - "Volatile metrics and status claims retain source dates and accessed dates where used; they must be refreshed before any public-facing or presentation use."
    - "Source-coverage limitations and Gap Analysis caveats are preserved from the approved draft."
  promotion_notes:
...
**研究窗口**：2026-02-24 至 2026-05-24。所有叙事 claim 默认要求在此窗口内有公开证据；更早信息仅作为 `[stale/background]`，不单独支撑"近期变化"。访问日期统一记录为 2026-05-24，除仓库内既有 final section 已记录的访问日期外，本 section 不再重写其历史访问时间。
...
2. **Tempo adoption gap**：Tempo 官网/docs 和 Visa validator announcement 能支撑近期叙事，但社媒覆盖和具体 partner production depth 仍不完整。使用时应继续明确所有 adoption claims 的 caveat。
...
11. **Twitter/X bias**：本 section 未完整抓取 X；不能把社媒覆盖视为完整互动分析。若需要社媒强结论，应单独抓取官方账号窗口内高互动帖。

## 11. Source Coverage

### 11.1 Fresh public anchors used in this section
...
| final | 2026-05-24 | Promoted approved round-1 draft to final.md. Preserved social/media coverage limits, volatile-metric refresh caveats, Source Coverage, and Gap Analysis. |
