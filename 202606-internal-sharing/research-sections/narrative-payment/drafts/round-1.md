...
artifact_paths:
  ...
  draft: "202606-internal-sharing/research-sections/narrative-payment/drafts/round-1.md"
...
# Payment Chain 叙事方向技术分析 - Draft Round 1
...
| Remittance 痛点 | World Bank RPW 是跨境汇款费用权威来源，G20 目标长期要求降低成本、提升速度和透明度 | RPW / World Bank active dataset, accessed 2026-05-26 | 2026-05-26 | verified-primary | 本稿 standard-depth 未逐页解析最新 PDF；只作痛点来源，不给未核验精确百分比 |
...
| 市场规模 | 可引用三个层次：链上稳定币供应/交易量、跨境汇款/B2B/merchant/Treasury 可服务市场、Mantle 本链稳定币约 $557.8M。不能把总 transfer volume 当 payment TAM。 |
...
| src-8 industry reports | Partial: World Bank RPW / FSB cross-border payments used for framework. Latest PDF numeric extraction was not completed; no unverified precision numbers are used. |
...
| World Bank RPW | `https://remittanceprices.worldbank.org/` | active dataset, accessed 2026-05-26 | 2026-05-26 | verified-primary | Remittance cost/speed framework, no exact unparsed figure |
...
2. **World Bank 最新 RPW PDF 未完整解析**：本稿不引用未核验的最新平均成本百分比；只用 RPW 作为 remittance cost framework。最终稿若要给精确汇款成本，应下载并解析最新 report / annex。
