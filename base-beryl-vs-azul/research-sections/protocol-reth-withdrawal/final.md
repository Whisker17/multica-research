...
promotion_metadata:
  approved_draft_path: base-beryl-vs-azul/research-sections/protocol-reth-withdrawal/drafts/round-2.md
  approved_draft_round: 2
  approved_draft_commit: f78d0c788af04f516642a3fd911d2f80f2a3fed0
  approval_evidence: "comment e9122ab7-42cd-4be5-87d7-c9fdca6036ea on issue 0170ae77-f28e-473f-9059-c98f48691453 (Research Review Agent, draft-review round 2, verdict: approve, severity: none)"
  outline_rounds: 2
  deep_rounds: 2
adversarial_review:
...
residual_caveats:
  - "Post-activation deployment verification pending: 3 deployment evidence items unresolved until Beryl mainnet activation (2026-06-25): (a) new AggregateVerifier deployed contract address; (b) DisputeGameFactory setImplementation registration tx; (c) deployed 5-day after-state eth_call confirmation"
draft_metadata:
  outline_round: 2
