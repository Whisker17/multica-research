...
| artifact_paths.draft | `base-beryl-vs-azul/research-sections/sepolia-window-confidence/drafts/round-3.md` |
...
| Mainnet 激活 | 2026-06-25 18:00 | Beryl fork 在 Mainnet 激活 | `4e84ba3d1` (#3627), timestamp `1782410400`; [status.base.org](https://status.base.org) 公告 "Mainnet: Base Beryl Upgrade - June 25th"（2026-06-19 发布）确认 2026-06-25 18:00 UTC 激活，要求 v1.1.1+，与 code timestamp 一致 | 主网上线 |
...
| status.base.org | 激活时间确认 | ✅ 引用 | Sepolia Beryl 激活公告（2026-06-12 发布）确认 2026-06-18 18:00 UTC + v1.1.0+ 要求，与 code timestamp `1781805600` 一致；Mainnet 公告 "Mainnet: Base Beryl Upgrade - June 25th"（2026-06-19 发布）确认 2026-06-25 18:00 UTC + v1.1.1+ 要求，与 code timestamp `1782410400` 一致。双网公告均已引用 |
...
| ~~Mainnet Beryl status.base.org 公告未发布~~ | ✅ 已解决：Mainnet 公告 "Mainnet: Base Beryl Upgrade - June 25th"（2026-06-19 发布）确认 2026-06-25 18:00 UTC + v1.1.1+，与 code timestamp `1782410400` + commit `4e84ba3d1` (#3627) 一致 | Sepolia + Mainnet 双网公告均已引用 |
...
| 3 | 2026-06-21 | **[Minor] Mainnet status.base.org 引用修正**：3 处更新——(1) §2.1 Mainnet 激活行：替换"截至 2026-06-21 尚未发布"为实际公告引用 "Mainnet: Base Beryl Upgrade - June 25th"（2026-06-19 发布），确认 2026-06-25 18:00 UTC + v1.1.1+；(2) Source Coverage：Mainnet 从"尚未发布"更新为双网公告均已引用；(3) Gap Analysis：Mainnet 公告缺口标记为 ✅ 已解决。 |
