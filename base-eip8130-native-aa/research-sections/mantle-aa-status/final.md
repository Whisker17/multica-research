...
final_promotion_metadata:
  promoted_from_draft: "base-eip8130-native-aa/research-sections/mantle-aa-status/drafts/round-1.md"
  approved_draft_round: 1
  approved_draft_commit: "8cdf529bdf9d2a9ccb435cf6f7314e3530f74c67"
  approval_evidence: "Review Verdict comment 850024ca-498b-487f-b12f-10e35da85737 approved the draft with severity minor; Orchestrator dispatch ef9c1365-e179-4fdd-9c43-e37a06f24d71 approved final promotion and accepted F1/F2 as supplementary caveats."
  promoted_at: "2026-06-27T09:45:00+08:00"
  carried_forward_caveats:
    - "F1: src-10 uses 2 of 3 required comparison chains (Base + Arbitrum); OP Mainnet omitted. Normalized-ratio argument is explicitly qualified as fragile."
    - "F2: src-11 expert commentary below minimum; primary conclusions rest on code analysis and on-chain data."
---
