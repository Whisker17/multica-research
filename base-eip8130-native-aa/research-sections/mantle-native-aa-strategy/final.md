...
draft_metadata:
  ...
  reviewer_minor_findings_incorporated:
    - "Draft review F1: item-2.4 now states that EIP-8130 composes with 7702-style delegation via AccountChange::Delegation, while 7702 remains the current bridge for EOA address continuity."
  diagram_assets:
...
final_promotion_metadata:
  promoted_from_draft: "base-eip8130-native-aa/research-sections/mantle-native-aa-strategy/drafts/round-1.md"
  approved_draft_round: 1
  approved_draft_commit: "cd796829ce49bd8d2684d33722b6542104398e69"
  approval_evidence: "Multica comment 784ce13e-381b-414e-8aa5-cf1d37176420 (Review Verdict: approve, severity minor, Research Review Agent)"
  promoted_at: "2026-06-27"
  reviewer_minor_findings_incorporated:
    - "F1: EIP-8130 composes with 7702-style delegation via AccountChange::Delegation; it does not replace 7702 or use 7702 SignedAuthorization as its main auth model. 7702 remains the current bridge for EOA address continuity."
---
...
Important 7702/8130 relationship: EIP-8130 composes with 7702-style delegation through `AccountChange::Delegation`; it does not replace 7702 or use 7702's `SignedAuthorization` as its main auth model. 7702 remains the current bridge for EOA address continuity.
