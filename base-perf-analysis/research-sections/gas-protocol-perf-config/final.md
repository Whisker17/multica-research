...
final_metadata:
  promoted_from_draft: base-perf-analysis/research-sections/gas-protocol-perf-config/drafts/round-1.md
  promoted_from_commit: ba55a2c0f1b73398f4186cecbfe95b96afa2ec15
  promoted_by: "agent:research-agent (Deep Research Agent, id=13a888db-49bb-4a19-9906-827729e156d9)"
  promoted_at: "2026-05-20T05:00:00Z"
  approval_evidence: "Direct user request via Multica issue WHI-57 comment 770ec5d6-2af1-4ff9-9a98-7d64ba17b9d2 in single-issue lightweight mode (no Orchestrator dispatch, no report_issue_id). Self-review checklist: outline items 1-8 covered; 4 Mermaid diagrams produced (diag-1..diag-4); source coverage meets outline minimums; gap analysis honest; quick wins enumerated with risk/complexity scoring."
