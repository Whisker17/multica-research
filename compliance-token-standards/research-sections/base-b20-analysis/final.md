...
status: final
artifact_paths:
  outline: compliance-token-standards/outlines/base-b20-analysis.md
  draft: compliance-token-standards/research-sections/base-b20-analysis/drafts/round-2.md
  final: compliance-token-standards/research-sections/base-b20-analysis/final.md
draft_metadata:
  outline_round: 2
  ...
  date: 2026-06-04
approval:
  approved_draft_path: compliance-token-standards/research-sections/base-b20-analysis/drafts/round-2.md
  approved_draft_round: 2
  approved_draft_commit: d1ad0564d2bd4f2b605ea9f43ab3d4799582006e
  approval_evidence: "comment 8eb92b08-f8b0-45ff-a428-b56eac3eb3cc (Review Verdict: approve, severity: none, Round 2)"
caveats:
  - "无正式 Base B20 规范——分析基于实现，需以最终公开 spec/Beryl hardfork release 为准"
  - "TIP-20 对比列标记为"待对比"——未引用 TIP-20 能力声明"
  - "ZK 基准：仅结构分析，无运行时指标"
  - "base/docs 仓库未检查是否存在 Beryl 文档"
  - "所有源码引用锚定至 base/base@8e8767281d7c8768f6a0aed9124779cd4ed030ae"
---
...
| Final | 2026-06-04 | 从 Round 2 草稿晋升为最终版本。经对抗性审查批准（Review Verdict: approve, severity: none）。 |
