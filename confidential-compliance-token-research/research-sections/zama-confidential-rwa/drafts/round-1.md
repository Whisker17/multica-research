...
| Claim | Evidence class | Source | Draft handling |
|---|---|---|---|
...
| Zama becomes confidentiality layer for T-REX Ledger; ERC-3643 enhanced but not replaced. | official partnership claim | `https://www.zama.org/post/zama-becomes-the-confidentiality-layer-for-the-t-rex-ledger`, published 2026-06-11, accessed 2026-06-24 | 可证明 partnership narrative；不能单独证明 Mantle-ready production deployment。 |
...
The prior confidential-coprocessor section records Zama live support and multi-chain roadmap caveats, but this draft did not find a primary source proving Mantle host-chain support as of 2026-06-24. Therefore item-5 classification is:
...
| src-2 | `https://www.zama.org/post/zama-becomes-the-confidentiality-layer-for-the-t-rex-ledger` | Published 2026-06-11; accessed 2026-06-24 | T-REX partnership, “enhances not replaces ERC-3643”, wrapping claim, vendor metrics | Medium for partnership; low for unverified metrics |
...
| src-9 | Independent corroboration | Partial: local finals cite secondary sources; this draft did not independently verify T-REX metrics or performance metrics | Deployment/performance/partnership corroboration remains incomplete | Low/partial |
...
9. **AC-8 `_index.md`**: WHI-267 mentions `_index.md`, but the Orchestrator selected lightweight single-issue mode without `report_issue_id`; this draft does not write `_index.md`.
