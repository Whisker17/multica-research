...
| 时间 | 里程碑 | 关键数据（已验证） |
|------|--------|------------------|
| 2025-11 | **Ignition Chain** 上线（首个去中心化 L2 协调层） | 11-19：~500 sequencer 质押并出块、4 家 proving 实体、共识上线、**36–72s 出块**、**初期空块**；早期 **185,000+ 用户** |
...
> **注**：outline 早期稿曾写「185+ 运营商 / 3,400+ sequencer / 99% uptime / 90 天无关键问题」。经本轮核对官方来源更正为：**185,000+ 用户**、Ignition 启动 **~500 sequencer**（验证方集合后续增长，关键漏洞博客提及 **~3,959 validators**）、Beta 条件为 **99.9% uptime + >10 TPS + 3 个月无关键 bug**。`[Gap Analysis G1]`
...
- **G1 — Ignition/网络规模数字口径已更正**：outline 早期稿的「185+ 运营商 / 3,400+ sequencer / 99% uptime / 90 天无关键问题」与官方来源不符。本轮按官方来源更正为 **185,000+ 用户、Ignition 启动 ~500 sequencer、关键漏洞博客提及 ~3,959 validators、Beta=99.9% uptime + >10 TPS + 3 个月无关键 bug**。验证方/sequencer 数量随时间变化，引用须带时点。**置信度：高（官方博客）**。
