...
status: final
promotion_metadata:
  promoted_from: "hoodi-launch-notice/research-sections/reth-adoption-trends/drafts/round-2.md"
  promoted_from_commit: "a71e81f"
  approval_evidence: "Review Verdict approve from Research Review Agent (comment d8c7ec61-e787-4d56-93c3-cd6c1785c11e)"
  promoted_at: "2026-05-27T15:07:00+08:00"
  pre_final_cleanup: "Removed placeholder S27 row (combined with S26, no URL/date); merged status-caveat purpose into S26"
...
| S26 | `okx/xlayer-reth` GitHub | https://github.com/okx/xlayer-reth | Active; retrieved 2026-05-27 | official GitHub | Reth-based execution client for XLayer (OP Stack-based L2); uses NodeBuilder API; status caveat |
