...
promotion_metadata:
  approved_draft_path: "mantle-base-codebase-evaluation/research-sections/performance-advantage-summary/drafts/round-1.md"
  approved_draft_round: 1
  approved_draft_commit: "a823349"
  approval_evidence: "Review Verdict approve — Research Review Agent comment d9c77e58-4373-46d3-9dec-0cb29d0adef5, severity: minor"
  outline_rounds: 2
  deep_rounds: 1
  ...
  caveats_incorporated:
    - "MaxPendingTx Base Current clarified: code-default=1; effective mainnet N>=5 inferred in capacity model"
    - "Brotli10 DA efficiency reframed to source-backed: +5-15% compression ratio / ~1.1-1.3x DA efficiency, unverified estimate"
    - "Gantt-style waterfall diagram removed; xychart labeled as canonical TPS milestone chart"
---
...
| **MaxPendingTx** | 1 (code-default, 序列化) | code-default=1; effective mainnet N≥5 inferred in capacity model | 5–10 (Quick Win 配置) | [batcher-pipeline §4.1] |
...
| **压缩算法** | Zlib | Brotli10 | Brotli10 (+5–15% compression ratio; ~1.1–1.3× DA efficiency, unverified estimate) | [batcher-pipeline §4.4] |
...
Mantle DA 优化杠杆优先级:
1. **P1 (立即)**: Zlib → Brotli10 (+5–15% compression ratio; ~1.1–1.3× DA efficiency, unverified estimate; 0 TPS 直接增益)
...
| **Tier 1 Exceptional** | 2 | MT-8 Brotli10 | +5–15% compression ratio; ~1.1–1.3× DA efficiency | 0.5 |
...
| MT-8 | Zlib → Brotli10 | +5–15% compression ratio; ~1.1–1.3× DA efficiency | CLI flag (0.5 day) | **P0 Quick Win** |
...
### Diagram 1: Performance Improvement TPS Milestone Chart (Canonical)
...
| Final | 2026-05-21 | Promoted to final. Incorporated 3 minor caveats from Review Verdict (d9c77e58): (1) MaxPendingTx Base Current clarified to `code-default=1; effective mainnet N≥5 inferred in capacity model` for consistency with saturated capacity table; (2) Brotli10 DA efficiency reframed from `~15–25%` to source-backed `+5–15% compression ratio; ~1.1–1.3× DA efficiency, unverified estimate`; (3) Gantt-style waterfall diagram removed, xychart labeled as canonical TPS milestone chart. Diagram count 3→2. |
