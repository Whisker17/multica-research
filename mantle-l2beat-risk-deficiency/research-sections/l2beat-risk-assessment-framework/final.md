...
approved_draft_artifact: mantle-l2beat-risk-deficiency/research-sections/l2beat-risk-assessment-framework/drafts/round-3.md
approved_draft_commit: 76c472cca7182063b715070e7c70412866678ffe
approval_evidence_comment: c7d75ead-5091-483c-b904-46f20157c468
...
draft_metadata:
  ...
  promoted_to_final_at: "2026-05-20T10:30:00Z"
  final_polish_notes: "§A.2.5 #409 posted-date corrected from 2025-11-10 (last-activity) to 2025-11-06 (first-post); §A.2.6 #381 posted-date corrected from 2025-07-19 (last-activity) to 2025-07-11 (first-post). Per Orchestrator dispatch (non-blocking source-hygiene note from Research Review approval, comment c7d75ead-5091-483c-b904-46f20157c468). No other content changes."
...
# L2Beat Risk Chart Proposer Failure 与 Exit Window 评估标准解析（Final）
...
| final | 2026-05-20 | promote | frontmatter（status: draft → final、加 `approved_draft_artifact` / `approved_draft_commit` / `approval_evidence_comment` / `promoted_to_final_at` / `final_polish_notes`；移除 `prior_round_*` draft 字段）、§ document title（"Round 3 Draft" → "Final"）、§A.2.5 #409 header（posted-date `2025-11-10` → `2025-11-06`，纠正 last-activity vs first-post）、§A.2.6 #381 header（posted-date `2025-07-19` → `2025-07-11`，纠正 last-activity vs first-post）、document footer（"END of round-3 draft" → "END of final section" + 加 promotion 元数据） | Round 3 Adversarial / Research Review verdict (comment `c7d75ead-5091-483c-b904-46f20157c468`)：recommend=**approve**, no further revision required. Non-blocking source-hygiene note: §A.2.5 / §A.2.6 header dates were last-activity dates, should be first-post dates. Orchestrator dispatch instructed to apply the date polish in final.md only and promote. Body / findings / diagrams / source coverage / appendix content unchanged. |
...
#### A.2.5 [Forum: New Stage 1 requirements for ZK setups #409](https://forum.l2beat.com/t/new-stage-1-requirements-for-zk-setups/409) (posted 2025-11-06; fetched 2026-05-20)
...
#### A.2.6 [Forum: The trusted setups framework for ZK Catalog #381](https://forum.l2beat.com/t/the-trusted-setups-framework-for-zk-catalog/381) (posted 2025-07-11; fetched 2026-05-20)
...
**END of final section** (promoted from round-3 draft, commit `76c472cca7182063b715070e7c70412866678ffe`; Adversarial approval evidence: comment `c7d75ead-5091-483c-b904-46f20157c468`; non-blocking date polish applied per Orchestrator dispatch — see frontmatter `final_polish_notes`)
